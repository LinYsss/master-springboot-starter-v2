package com.wayakeji.common.core.util.xml;
...
public class XMLSerializer {
	 ...
	 */
	public static Map<String, Object> parse(byte[] bytes) throws DocumentException, SAXException {
	 ...
	 * @throws SAXException      当初始化解析器错误时抛出
	 */
	public static Map<String, Object> parse(InputStream in) throws DocumentException, SAXException {
	 ...
	 * @throws DocumentException 当解析数据错误时抛出
	 */
	public static Map<String, Object> parse(String text) throws DocumentException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String, Object> parse(Element e) {
		Map<String, Object> map = new HashMap<>();
	...
	private static void addList(Map<String, Object> map, Element elem, List<Object> mapl) {
	...
	private static void addList(Map<String, Object> map, Object value, Element elem, List<Object> mapl) {
	 ...
	 */
	public static SAXReader buildReader() throws SAXException {
