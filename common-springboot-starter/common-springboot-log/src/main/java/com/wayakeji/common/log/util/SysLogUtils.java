...
package com.wayakeji.common.log.util;
...
public class SysLogUtils {
	...
	public AuthorityLog getSysLog() {
		HttpServletRequest request = ((ServletRequestAttributes) Objects
				.requireNonNull(RequestContextHolder.getRequestAttributes())).getRequest();
		AuthorityLog sysLog = new AuthorityLog();
...
//		sysLog.setCreateBy(LoginHelper.getUsername());
//		sysLog.setUpdateBy(LoginHelper.getUsername());
		return sysLog;
	}
