 ...
 * @author
 * @since 2021年10月11日
 * @NoArgsConstructor 作用于类，生成一个无参构造方法
 * PaginationInnerInterceptor
 * MybatiPlus的分页插件PaginationInnerInterceptor
 */
@Data
@NoArgsConstructor
public class MybatisPlusPaginationInnerInterceptor extends PaginationInnerInterceptor {
	...
	public MybatisPlusPaginationInnerInterceptor(DbType dbType) {
		this.dbType = dbType;
	}

	public MybatisPlusPaginationInnerInterceptor(IDialect dialect) {
