 ...
 * @since 1.8
 */
public class SendRedPack extends CommonPojo {
	 ...
	 * @param remark      备注
	 */
	public SendRedPack(String sendName, String reOpenid, int totalAmount, int totalNum, String wishing, String actName
			, String remark) {
	 ...
	 * @param remark      备注
	 */
	public SendRedPack(String sendName, String reOpenid, int totalAmount, int totalNum, String wishing,
	 ...
	 * @param remark      备注
	 */
	public SendRedPack(String mchBillno, String sendName, String reOpenid, int totalAmount, int totalNum,
	 ...
	 * @param remark      备注
	 */
	public SendRedPack(String nonceStr, String mchBillno, String sendName, String reOpenid,
